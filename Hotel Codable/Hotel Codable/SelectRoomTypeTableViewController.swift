...
//  Hotel Codable
//
//  Created by srishti  on 28/08/25.
//

import UIKit

protocol SelectRoomTypeTableViewControllerDelegate : AnyObject {
    func selectRoomTypeTableViewControllerDidSelect(_ contoller : SelectRoomTypeTableViewController,didSelect roomType : RoomType)
